...
const mysel_db_config_1 = __importDefault(require("../mysel.db.config"));
...
authRouter.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        mysel_db_config_1.default.execute(sql, values, (err, results) => {
            if (err)
...
authRouter.post("/register", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        mysel_db_config_1.default.execute(sql, values, (err, result) => {
            if (err)
